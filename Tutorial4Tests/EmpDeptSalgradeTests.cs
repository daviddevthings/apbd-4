...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnEmployeesFromChicago()
    {
        ...
        List<Emp> result = emps
            .Where(e =>
                depts.Where(dept => dept.Loc == "Chicago")
    ...
    public void ShouldReturnEmployeesEarningMoreThanDeptAverage()
    {
        ...
        var avgSalariesinDepts = emps
            .GroupBy(emp => emp.DeptNo)
            .ToDictionary(g => g.Key, g => g.Average(emp => emp.Sal));
        
        var result = emps
            .Where(emp => avgSalariesinDepts.ContainsKey(emp.DeptNo) && emp.Sal > avgSalariesinDepts[emp.DeptNo])
